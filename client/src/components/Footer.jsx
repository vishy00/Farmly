...
const Footer = () => {
    ...
    return (
       <div>
            <footer className="flex flex-col bg-transparent backdrop-blur-md items-center justify-around w-full py-8 text-sm text-gray-800/70">
                <div className="flex items-center gap-8">
                    <a href="#" className="font-medium text-gray-500 hover:text-orange-500 transition-all">
                        Home
                    </a>
                    <a href="#" className="font-medium text-gray-500 hover:text-orange-500 transition-all">
                        About
                ...
                <p className="mt-8 text-center">Copyright © 2025 <a href="https://theuselessweb.com">Farmly</a>. All rights reservered.</p>
            </footer>
       </div>
    );
};
